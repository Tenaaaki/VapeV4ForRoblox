loadstring(game:HttpGet("https://raw.githubusercontent.com/Tenaaaki/VapeV4ForRoblox/"..readfile("vape/commithash.txt").."/CustomModules/6872274481.lua", true))()
--[[ 
	Credits
...
actuallogo.Text = "Pistonware | Bedwars | 6872274481"
